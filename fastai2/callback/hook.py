...
__all__ = ['can_call_with_n_positional_args', 'Hook', 'hook_output', 'Hooks', 'hook_outputs', 'dummy_eval',
           'model_sizes', 'num_features_model', 'has_params', 'HookCallback', 'total_params', 'layer_info',
           'ActivationStats']
...
def can_call_with_n_positional_args(fn, n):
    ...
    # TODO: maybe this belongs in fastcode utils?
